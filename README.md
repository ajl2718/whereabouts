...
A lightweight, fast geocoder for Python using DuckDB. Try it out online at [Hugging Face](https://huggingface.co/spaces/saunteringcat/whereabouts-geocoding).
...
<p align="center">
  <img src="geocoder_comparison_residential_050924.png" alt="Geocoding accuracy on a set of residential addresses" width="45%"/>
