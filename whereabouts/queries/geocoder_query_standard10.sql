...
LEFT JOIN best_matches_ranked t2 ON t1.address_id = t2.address_id1
WHERE (t2.rank <= ?) OR (t2.rank IS NULL) -- select top matches, preserve unmatched inputs
ORDER BY t1.address_id, t2.rank
